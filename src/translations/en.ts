  ...
  translation: {
    ...
    [Paths.Eeg]: {
      ...
      navbar: {
        ...
        '6-subText': 'Press the button to start the EEG machine and get your results.',
        '6-buttonText': 'Continue',
        '7-mainText': 'PRINTING...',
        '7-subText': 'The EEG machine is working and printing out the results.',
        '7-buttonText': 'Continue',
        '8-mainText': 'Great Job',
        '8-subText': 'The EEG test is finished. Choose a reward for the patient!',
        '8-buttonText': 'Continue',
        '9-subText': 'You finished the EEG! Tap below to learn more about the nervous system.',
      },
    },
    [Paths.Wellness]: {
      header: {
