...
import XRayView from './IvAssets/xRayView.svg';
...
import BandageSelection from './IvAssets/bandageSelection.svg';
import BandagePlaced from './IvAssets/bandagePlaced.svg';
