const Sounds = {
  ...
  eEGAttachElectrodes: new Audio('sounds/EEG_Attach_Electrodes_Single.mp3'),
  eEGMachine: new Audio('sounds/EEG_Machine.mp3'),
  eEGSock: new Audio('sounds/EEG_Sock.mp3'),
  eEGTabs: new Audio('sounds/EEG_Tabs_Single.mp3'),
  ...
  ivNeedle: new Audio('sounds/IV_Needle.mp3'),
  iVTourniquet: new Audio('sounds/IV_Tourniquet.mp3'),
  ...
  mainScreenSwoosh: new Audio('sounds/Main_Screen_Swoosh.mp3'),
